...
while True:    #This simulates a Do Loop
    ...
    print("Ik heb een getal van " + str(minimum) + " t/m " + str(maximum) + " in mijn hoofd. Wat denk jij dat het getal is?")
    ...
    while geheimeGetal != geradenGetal and stoppen == "ja":
        if geradenGetal < geheimeGetal:
            print("Het getal dat ik in mijn hoofd heb is hoger dan het geraden getal. Wil je verderspelen? (ja/nee)")
            stoppen = input()
            while stoppen != "nee" and stoppen != "ja":
                print("Je moet wel ja of nee invullen! Wil je verderspelen? (ja/nee)")
                stoppen = input()
            aantalGeraden = aantalGeraden + 1
        else:
            print("Het getal dat ik in mijn hoofd heb is lager dan het geraden getal. Wil je verderspelen? (ja/nee)")
            stoppen = input()
            while stoppen != "nee" and stoppen != "ja":
                print("Je moet wel ja of nee invullen! Wil je verderspelen? (ja/nee)")
                stoppen = input()
            aantalGeraden = aantalGeraden + 1
        if stoppen == "ja":
            print("Wat denk je dat het nu is?")
            geradenGetal = int(input())
            while geradenGetal > maximum or geradenGetal < minimum:
                print("Ik zei toch een getal tussen de " + str(minimum) + " en de " + str(maximum) + "! Doe maar weer opnieuw")
                geradenGetal = int(input())
